# ================================
# Script de Build para UMC (Versão Final Corrigida - m_blockMap, m_systemAllocations)
# Autor: Luis
# ================================
...
# Início do timer
$start = Get-Date
Write-Host "Iniciando compilação UMC (versão com m_blockMap e m_systemAllocations)..."
...
Write-Host "Copiando VirtualGpuMemory_final_v2.h para VirtualGpuMemory.h..."
Copy-Item -Path "VirtualGpuMemory_final_v2.h" -Destination "VirtualGpuMemory.h" -Force
