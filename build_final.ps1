# ================================
# Script de Build para UMC (Versão Final Corrigida)
# Autor: Luis
# ================================
...
# Início do timer
$start = Get-Date
Write-Host "Iniciando compilação UMC (versão final corrigida)..."
...
Write-Host "Copiando VirtualGpuMemory_fixed2.h para VirtualGpuMemory.h..."
Copy-Item -Path "VirtualGpuMemory_fixed2.h" -Destination "VirtualGpuMemory.h" -Force
