# ================================
# Script de Build para UMC (Versão Corrigida)
# Autor: Luis
# ================================
...
# Início do timer
$start = Get-Date
Write-Host "Iniciando compilação UMC (versão corrigida)..."
...
Write-Host "Copiando VirtualGpuMemory_fixed.h para VirtualGpuMemory.h..."
Copy-Item -Path "VirtualGpuMemory_fixed.h" -Destination "VirtualGpuMemory.h" -Force
