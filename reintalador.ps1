...
:: 4) Reinstalar Microsoft Store e dependências
Get-AppxPackage -allusers Microsoft.WindowsStore | Reset-AppxPackage
Get-AppxPackage -allusers Microsoft.WindowsStore | Add-AppxPackage -Register
...
:: 9) Reinstalar drivers OEM via Windows Update
