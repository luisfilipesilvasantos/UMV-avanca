# ================================
# Script de Build para UMC (Versão Final Corrigida - com cuda_runtime.h)
# Autor: Luis
# ================================
...
# Início do timer
$start = Get-Date
Write-Host "Iniciando compilação UMC (versão com cuda_runtime.h)..."

# Limpar builds anteriores
Write-Host "Limpando ficheiros OBJ e EXE..."
Get-ChildItem *.obj, *.exe -ErrorAction SilentlyContinue -Force | Remove-Item -Force
...
Write-Host "Copiando VirtualGpuMemory_final_v5.h para VirtualGpuMemory.h..."
Copy-Item -Path "VirtualGpuMemory_final_v5.h" -Destination "VirtualGpuMemory.h" -Force
