# ================================
# Script de Build para UMC (Versão Final Corrigida - m_blocks, m_mutex mutable)
# Autor: Luis
# ================================
...
# Início do timer
$start = Get-Date
Write-Host "Iniciando compilação UMC (versão com m_blocks e m_mutex mutable)..."
...
Write-Host "Copiando VirtualGpuMemory_final_v3.h para VirtualGpuMemory.h..."
Copy-Item -Path "VirtualGpuMemory_final_v3.h" -Destination "VirtualGpuMemory.h" -Force
